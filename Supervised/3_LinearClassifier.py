...
#Comparing scores of Logistic Regression vs SVM the same dataset
...
# Predict whether these reviews are positive or negative
...
#Showing diffrences between 4 classifiers types
